...
// openssl>=1.0.2 has SSL_is_server API to check if the ssl connection is
// server.  Older versions does not have this function. Hence this function is
// introduced.

enum evt_endpt_t { ENDPT_IS_CLIENT, ENDPT_IS_SERVER };
